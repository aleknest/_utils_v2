...
module schneckenradsatz_big(modul, zahnzahl, gangzahl, breite, laenge, bohrung_schnecke, bohrung_rad, eingriffswinkel=20, steigungswinkel, optimiert=true, zusammen_gebaut=true){
...
module schneckenradsatz_small(modul, zahnzahl, gangzahl, breite, laenge, bohrung_schnecke, bohrung_rad, eingriffswinkel=20, steigungswinkel, optimiert=true, zusammen_gebaut=true){
...
kk=0.5;color ("red")
//translate ([50,0,0])
//// schneckenradsatz(modul=kk, zahnzahl=30/kk, gangzahl=2/kk, breite=8, laenge=20, bohrung_schnecke=4, bohrung_rad=4, eingriffswinkel=20, steigungswinkel=10, optimiert=true, zusammen_gebaut=true);
 
 schneckenradsatz_small(modul=kk, zahnzahl=30/kk, gangzahl=2/kk, breite=8, laenge=20, bohrung_schnecke=4, bohrung_rad=4, eingriffswinkel=20, steigungswinkel=10, optimiert=true, zusammen_gebaut=true);